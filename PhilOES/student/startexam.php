...
(function addDot() {
  setTimeout(function() {
   ...
   /// Prevent user from switching between tabs and minimizing windows
  let isSessionEnded = false;

document.addEventListener('visibilitychange', function() {
  if (document.hidden && !isSessionEnded) {
    isSessionEnded = true; // Set a flag to indicate the session has already ended
    // When the tab is switched or window is minimized
    fetch('/endExam', {
      method: 'POST',
      headers: {
...
<tr> <td></td> <td><li>Do not Switch tabs</li></td></tr>
<tr> <td></td> <td><li>Do not Minimize Windows</li></td></tr>
<tr> <td></td> <td><li>Make sure you have a stable internet connection</li></td></tr>
